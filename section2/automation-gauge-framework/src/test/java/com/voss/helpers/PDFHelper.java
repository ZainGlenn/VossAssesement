...
public class PDFHelper {
    ...
    public PDFHelper(String path) {
        ...
        if (!pdfFile.exists()) {
            throw new AutomationTestRuntimeException("Failed to locate pdf with path " + path, new Throwable());
        }
        ...
        try {
            ...
            throw new AutomationTestRuntimeException("Failed to locate pdf with path " + path, new Throwable(e));
        }
    }
    ...
    private String createContents(PDDocument document) {
        try {
            ...
            throw new AutomationTestRuntimeException("Failed to load pdf contents", new Throwable());
        }
    }
